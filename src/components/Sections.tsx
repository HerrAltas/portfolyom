...
export const Hero: React.FC<{
  ...
  const words = useMemo(
    () => ["Developer", "Innovator", "Quick Learner", "Problem Solver"],
    []
  );
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        <h1 className="text-5xl md:text-8xl font-display font-bold text-gray-900 dark:text-white mb-8 leading-tight animate-slide-up">
          Ich bin <br className="md:hidden" />
        ...
        <div
          className="flex flex-col sm:flex-row justify-center gap-6 animate-slide-up"
          style={{ animationDelay: "0.3s" }}
        >
          <a
            href="#contact"
            onClick={(e) => scrollToSection(e, "#contact")}
            className="group px-8 py-4 rounded-full bg-blue-600 text-white font-bold text-lg hover:bg-blue-700 hover:shadow-lg transition-all flex items-center justify-center gap-2 transform hover:-translate-y-1"
          >
            {t.hero.cta_primary}{" "}
          ...
          <button
            ...
            className="px-8 py-4 rounded-full bg-white dark:bg-white/5 text-gray-800 dark:text-white font-bold text-lg border border-gray-200 dark:border-white/10 hover:bg-gray-50 dark:hover:bg-white/10 transition-all flex items-center justify-center gap-2"
          >
...
export const About: React.FC = () => {
  ...
  return (
    <section
      id="about"
      className="py-32 bg-white dark:bg-dark relative overflow-hidden"
    >
...
export const Skills: React.FC = () => {
  ...
  return (
    <section
      id="skills"
      className="py-32 bg-gray-50 dark:bg-slate-950 relative overflow-hidden"
    >
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <div className="h-[450px] w-full max-w-2xl mx-auto bg-white/50 dark:bg-slate-900/50 backdrop-blur-xl rounded-[2rem] border border-white/60 dark:border-white/5 shadow-2xl p-4">
          <ResponsiveContainer width="100%" height="100%">
            <RadarChart cx="50%" cy="50%" outerRadius="75%" data={SKILLS_DATA}>
              ...
              <PolarAngleAxis
                dataKey="subject"
                tick={{ fill: textColor, fontSize: 13, fontWeight: 700 }}
              />
              <Radar
                name="Skills"
                dataKey="A"
        ...
        <div className="mt-16 flex flex-wrap justify-center gap-4 max-w-4xl mx-auto">
          {techStack.map((tech, idx) => (
            <div
              key={idx}
              className="px-6 py-3 bg-white dark:bg-slate-800 rounded-full shadow-sm border border-gray-100 dark:border-slate-700 text-gray-700 dark:text-gray-300 font-semibold text-sm hover:scale-110 transition-all cursor-default"
            >
              {tech}
            </div>
          ))}
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {posts.slice(0, 3).map((post) => (
              <div
                key={post.id}
                onClick={() => onViewChange?.("article", post.id)}
                className="group cursor-pointer flex flex-col h-full bg-white dark:bg-slate-900 rounded-3xl overflow-hidden shadow-sm border border-gray-100 dark:border-slate-800 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2"
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  />
                  <span className="absolute top-4 left-4 z-20 px-3 py-1 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md text-xs font-bold rounded-full text-blue-600">
                    {post.category}
                  </span>
                </div>
                <div className="p-8 flex flex-col flex-grow">
                  ...
                  <div className="mt-auto flex items-center gap-2 text-sm font-bold text-gray-900 dark:text-white">
      ...
      <div className="relative h-[70vh] w-full">
        ...
        <div className="absolute bottom-0 left-0 w-full p-10 md:p-20 z-10">
          <div className="container mx-auto max-w-4xl">
            <button
              onClick={onBack}
              className="flex items-center gap-2 text-white/80 hover:text-white mb-10 transition-colors font-semibold bg-white/10 backdrop-blur-md px-4 py-2 rounded-full border border-white/20"
            >
            ...
            <div className="flex flex-wrap items-center gap-6 text-white/80 text-sm">
              ...
              <div className="flex items-center gap-2">
                <img
                  src="https://ui-avatars.com/api/?name=Mustafa+Altas&background=3b82f6&color=fff"
          ...
          <div className="article-content space-y-8 text-lg md:text-xl">
            {post.content.map((paragraph, index) => (
              <p
                ...
                className={
                  index === 0
                    ? "first-letter:text-7xl first-letter:font-bold first-letter:text-blue-600 first-letter:mr-3 first-letter:float-left first-letter:font-display"
                    : ""
                }
              >
                {paragraph}
        ...
        <div className="mt-20 pt-12 border-t border-gray-100 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-8">
          <div>
            ...
            <p className="text-gray-500">
              Daha fazla içerik için beni takip edebilir veya iletişime
              geçebilirsiniz.
            </p>
          </div>
          <div className="flex gap-4">
            <button className="p-4 bg-gray-50 dark:bg-slate-900 rounded-2xl hover:bg-blue-600 hover:text-white transition-all">
              <Twitter />
            </button>
            <button className="p-4 bg-gray-50 dark:bg-slate-900 rounded-2xl hover:bg-blue-600 hover:text-white transition-all">
              <Linkedin />
  ...
  return (
    <div className="min-h-screen pt-32 pb-20 bg-gray-50 dark:bg-slate-950">
      <div className="container mx-auto px-6">
        <button
          onClick={onBack}
          className="flex items-center gap-2 text-gray-600 hover:text-blue-600 mb-12 font-semibold"
        >
          <ArrowLeft className="w-5 h-5" /> {t.blog.back_to_home}
        </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {currentPosts.map((post) => (
            <div
              ...
              className="group cursor-pointer flex flex-col h-full bg-white dark:bg-slate-900 rounded-3xl overflow-hidden shadow-sm border border-gray-100 dark:border-slate-800 hover:shadow-2xl transition-all duration-300"
            >
              <div className="relative h-48 overflow-hidden">
                <img
                  src={post.image}
        ...
        {totalPages > 1 && (
          <div className="flex justify-center items-center gap-4">
            <button
              ...
              className="p-3 rounded-full bg-white dark:bg-slate-800 border disabled:opacity-50"
            >
              <ChevronLeft />
            </button>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-12">
          <div className="md:w-1/3">
            <h2 className="text-4xl font-bold mb-6 text-gray-900 dark:text-white font-display">
              ...
              <span className="block text-lg font-normal text-gray-500 mt-2 font-sans">
            ...
            <div className="bg-gray-50 dark:bg-slate-900 p-10 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-slate-800 relative group">
              ...
              <div className="mt-12 flex items-center justify-end gap-5">
                <div className="flex flex-col items-end">
                  <span className="font-display font-bold text-2xl text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">
                    Mustafa Altas
                  </span>
                </div>
      ...
      <div className="container mx-auto px-6">
        <div className="relative overflow-hidden rounded-[3rem] bg-dark text-white p-12 md:p-24 text-center group shadow-2xl">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <div className="inline-flex items-center justify-center p-5 bg-white/10 backdrop-blur-md rounded-2xl mb-8 border border-white/20">
              <FileText className="w-10 h-10 text-white" />
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-display">
              {t.cv.title}
            </h2>
            <p className="text-blue-50 text-xl mb-10 leading-relaxed opacity-90">
              {t.cv.description}
            </p>

            <a
              href="../../public/Mustafa_Altas_Cv.pdf"
              download
              className="inline-flex items-center justify-center gap-3 bg-white text-blue-700 font-bold px-10 py-5 rounded-full shadow-2xl hover:scale-105 hover:bg-blue-50 active:scale-95 transition-all duration-300 mx-auto text-lg max-w-md w-full
"
            >
              <Download className="w-6 h-6" /> {t.cv.download}
            </a>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col md:flex-row border border-gray-100 dark:border-slate-800">
          <div className="p-12 md:w-2/5 bg-gradient-to-br from-blue-600 to-indigo-800 text-white flex flex-col justify-between">
            ...
            <div className="space-y-8">
              <a
                href="mailto:mustafaaltasch@gmail.com"
          ...
          <div className="p-12 md:w-3/5 bg-white dark:bg-slate-900">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <button
                ...
                className="w-full py-5 font-bold text-lg rounded-2xl bg-blue-600 text-white shadow-xl hover:-translate-y-1 transition-all flex items-center justify-center gap-3"
              >
                {status === "sending" ? (
